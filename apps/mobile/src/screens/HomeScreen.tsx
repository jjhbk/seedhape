      ...
      {!hasPermission && (
        ...
        >
          ...
          <Text style={styles.warningText}>
            Tap to grant permission to automatically verify UPI payments.
          </Text>
        </TouchableOpacity>
      )}
      ...
      {merchant && !merchant.upiId && (
        <View style={styles.infoBanner}>
          <Text style={styles.infoText}>
            Set your UPI ID in Settings to start accepting payments.
          </Text>
        </View>
      )}
          ...
          <View key={tx.id} style={styles.txRow}>
            ...
            <View style={styles.txRight}>
              <View
                style={[
                  styles.txStatus,
                  { backgroundColor: tx.status === 'VERIFIED' ? '#dcfce7' : '#fef9c3' },
                ]}
              >
                <Text
                  style={[
                    styles.txStatusText,
                    { color: tx.status === 'VERIFIED' ? '#166534' : '#854d0e' },
                  ]}
                >
                  {tx.status}
                </Text>

...
import { UPI_APP_PACKAGES, UPI_APP_NAMES } from '@seedhape/shared';
import { getMerchantProfile } from '../services/api.js';
...
export default function SettingsScreen() {
  ...
  async function loadProfile() {
    ...
    if (!token) return;
    const data = await getMerchantProfile(token) as Profile | null;
    if (data) {
      setProfile(data);
      setUpiId(data.upiId ?? '');
  ...
  async function save() {
    ...
    setSaving(false);
    Alert.alert(res.ok ? 'Saved' : 'Error', res.ok ? 'Settings updated.' : 'Failed to save settings.');
  }
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.hint}>
            Money is sent directly to this UPI ID — no SeedhaPe cut.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          />
          <Text style={styles.hint}>
            We'll POST to this URL when a payment is verified or expires.
          </Text>
        </View>
      </View>
